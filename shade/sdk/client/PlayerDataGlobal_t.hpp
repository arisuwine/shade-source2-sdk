    ...
    namespace sdk {
        namespace client {
            ...
            struct PlayerDataGlobal_t {
                ...
                C_NetworkUtlVectorBase<CUtlStringToken> m_vecUpgrades; // 0x0098, 0x18 bytes
                C_NetworkUtlVectorBase<CUtlStringToken> m_vecBonusCounterAbilities; // 0x00b0, 0x18 bytes
                C_NetworkUtlVectorBase<std::int32_t> m_vecBonusCounterValues; // 0x00c8, 0x18 bytes
                C_NetworkUtlVectorBase<CUtlStringToken> m_vecBonusCounterModifiers; // 0x00e0, 0x18 bytes
                C_NetworkUtlVectorBase<std::int32_t> m_vecModifierBonusCounterValues; // 0x00f8, 0x18 bytes
                CUtlStringToken m_tHeldItem; // 0x0110, 0x4 bytes
                std::uint8_t pad_0114[0x4]; // 0x0114, 0x4 bytes
                C_UtlVectorEmbeddedNetworkVar<shade::sdk::client::ItemImbuementPair_t> m_vecImbuements; // 0x0118, 0x68 bytes
                C_UtlVectorEmbeddedNetworkVar<shade::sdk::client::DynamicAbilityValues_t> m_vecDynamicAbilityValues; // 0x0180, 0x68 bytes
                C_UtlVectorEmbeddedNetworkVar<shade::sdk::client::StatViewerModifierValues_t> m_vecStatViewerModifierValues; // 0x01e8, 0x68 bytes
                C_UtlVectorEmbeddedNetworkVar<shade::sdk::client::StolenAbilityPair_t> m_vecStolenAbilities; // 0x0250, 0x68 bytes
                C_UtlVectorEmbeddedNetworkVar<shade::sdk::client::AbilityUpgradeState_t> m_vecAbilityUpgradeState; // 0x02b8, 0x68 bytes
