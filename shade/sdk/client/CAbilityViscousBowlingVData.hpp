...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CAbilityViscousBowlingVData : public shade::sdk::client::CitadelAbilityVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_ImpactModifier; // 0x1ea0, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_DamagePreventionModifier; // 0x1eb0, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_RollingModifier; // 0x1ec0, 0x10 bytes
