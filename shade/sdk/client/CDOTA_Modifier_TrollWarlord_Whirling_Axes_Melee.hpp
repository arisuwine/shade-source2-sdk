    ...
    namespace sdk {
        namespace client {
            ...
            public:
                ...
                CUtlVector<CHandle<shade::sdk::client::C_BaseEntity>> hitEntities; // 0x1ab8, 0x18 bytes
                CUtlVector<CHandle<shade::sdk::client::C_BaseEntity>> m_hAxes; // 0x1ad0, 0x18 bytes
            };
            #pragma pack(pop)
