...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Ability_MobileResupplyVData : public shade::sdk::client::CitadelAbilityVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CBaseModifier> m_AuraModifier; // 0x1840, 0x10 bytes
