...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CNPC_BarrackBossVData : public shade::sdk::client::CAI_CitadelNPCVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_BackdoorBulletResistModifier; // 0x13d8, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_ObjectiveRegen; // 0x13e8, 0x10 bytes
            };
            #pragma pack(pop)
