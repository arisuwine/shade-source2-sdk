    ...
    namespace sdk {
        namespace client {
            enum class EModifierValue : std::uint32_t {
                ...
                MODIFIER_VALUE_ULTIMATE_COOLDOWN_REDUCTION_PERCENTAGE = 0x66,
                MODIFIER_VALUE_BONUS_ABILITY_CHARGES = 0x67,
                MODIFIER_VALUE_BONUS_ABILITY_DURATION_PERCENTAGE = 0x68,
                MODIFIER_VALUE_ENABLE_CHARGES = 0x69,
                MODIFIER_VALUE_MELEEATTACK_SPEED = 0x6a,
                MODIFIER_VALUE_MELEE_TRAVEL_DISTANCE_PERCENTAGE = 0x6b,
                MODIFIER_VALUE_PARRY_COOLDOWN_REDUCTION_FIXED = 0x6c,
                MODIFIER_VALUE_FIREARM_ACCURACY_PERCENTAGE = 0x6d,
                MODIFIER_VALUE_TURN_SIDEMOVE_PERCENTAGE = 0x6e,
                MODIFIER_VALUE_CHARGE_SPEED = 0x6f,
                MODIFIER_VALUE_TELEPORT_COOLDOWN_REDUCTION_PERCENT = 0x70,
                MODIFIER_VALUE_FALL_SPEED_MAX = 0x71,
                MODIFIER_VALUE_AIR_SPEED_MAX = 0x72,
                MODIFIER_VALUE_BULLET_EVASION = 0x73,
                MODIFIER_VALUE_PARRY_PIERCE = 0x74,
                ...
                MODIFIER_VALUE_BARRIER_HEALTH = 0x78,
                MODIFIER_VALUE_BONUS_CRIT_DAMAGE_PERCENT = 0x79,
                MODIFIER_VALUE_HEIGHT_ADVANTAGE_BONUS_BASE_DAMAGE_PERCENT = 0x7a,
                MODIFIER_VALUE_BONUS_WEAPON_DAMAGE_CLOSE_RANGE_MAX_RANGE = 0x7b,
                MODIFIER_VALUE_BONUS_BULLET_DAMAGE_LONG_RANGE_MIN_RANGE = 0x7c,
                ...
                MODIFIER_VALUE_FREE_AIR_JUMPS = 0x85,
                MODIFIER_VALUE_ZIP_LINE_SPEED_ADDITIVE = 0x86,
                MODIFIER_VALUE_ZIP_LINE_SPEED_PERCENTAGE = 0x87,
                MODIFIER_VALUE_CLIMB_ROPE_SPEED_PERCENTAGE = 0x88,
                ...
                MODIFIER_VALUE_CLOAK_DESAT_FACTOR = 0x8d,
                MODIFIER_VALUE_PARTICLE_TINT_OVERRIDE = 0x8e,
                MODIFIER_VALUE_PARTICLE_DESAT_OVERRIDE = 0x8f,
                MODIFIER_VALUE_DIMENSION_TYPE = 0x90,
                MODIFIER_VALUE_GAMEPLAY_TIME_SCALE_ADDITIVE = 0x91,
                MODIFIER_VALUE_GAMEPLAY_TIME_SCALE_PERCENT = 0x92,
                MODIFIER_VALUE_ANIMATION_TIME_SCALE_ADDITIVE = 0x93,
                MODIFIER_VALUE_ANIMATION_TIME_SCALE_PERCENT = 0x94,
                MODIFIER_VALUE_ANIMATION_FRAME_SKIP_RATE = 0x95,
                MODIFIER_VALUE_MOVEMENT_TIME_SCALE_ADDITIVE = 0x96,
                MODIFIER_VALUE_MOVEMENT_TIME_SCALE_PERCENT = 0x97,
                MODIFIER_VALUE_PARTICLE_TIME_SCALE_ADDITIVE = 0x98,
                MODIFIER_VALUE_PARTICLE_TIME_SCALE_PERCENT = 0x99,
                MODIFIER_VALUE_STAMINA = 0x9a,
                MODIFIER_VALUE_STAMINA_REGEN_PER_SECOND_ADDITIVE = 0x9b,
                MODIFIER_VALUE_STAMINA_REGEN_PER_SECOND_PERCENTAGE = 0x9c,
                MODIFIER_VALUE_WEAPON_POWER = 0x9d,
                MODIFIER_VALUE_ARMOR_POWER = 0x9e,
                MODIFIER_VALUE_TECH_POWER = 0x9f,
                MODIFIER_VALUE_TECH_POWER_PERCENT = 0xa0,
                ...
                MODIFIER_VALUE_VISUAL_ORIGIN_OFFSET = 0xb0,
                MODIFIER_VALUE_SPECTATING_SPEED_OVERRIDE = 0xb1,
                MODIFIER_VALUE_WEAPON_DAMAGE_TO_NPC_INCREASE = 0xb2,
                MODIFIER_VALUE_AIR_DRAG = 0xb3,
                MODIFIER_VALUE_FALLING_DRAG = 0xb4,
                ...
                MODIFIER_VALUE_PENDING_INCOMING_HEAL = 0xcd,
                ...
                MODIFIER_VALUE_RESPAWN_TIME_PERCENTAGE = 0xd1,
                ...
                MODIFIER_VALUE_HERO_BULLET_LIFESTEAL_EFFECTIVENESS = 0xd8,
                MODIFIER_VALUE_HERO_SPIRIT_LIFESTEAL_EFFECTIVENESS = 0xd9,
                MODIFIER_VALUE_PARRY_FX_OVERRIDE = 0xda,
                MODIFIER_VALUE_CAMERA_ENTITY_OVERRIDE = 0xdb,
                MODIFIER_VALUE_VISION_RADIUS = 0xdc,
                MODIFIER_VALUE_MINIMAP_POSITION_OVERRIDE = 0xdd,
                MODIFIER_VALUE_HERO_CARD_OVERRIDE = 0xde,
                MODIFIER_VALUE_SELFCAST_TARGET_OVERRIDE = 0xdf,
                MODIFIER_VALUE_HERO_ATTACH_PARENT = 0xe0,
                MODIFIER_VALUE_DOORWAY_MINIMAP_RANGE = 0xe1,
                MODIFIER_VALUE_COUNT = 0xe2,
