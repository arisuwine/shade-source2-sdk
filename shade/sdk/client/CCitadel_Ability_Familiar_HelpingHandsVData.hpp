...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Ability_Familiar_HelpingHandsVData : public shade::sdk::client::CitadelAbilityVData {
            public:
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_AIPhysicsModifier; // 0x1818, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_AIAggroModifier; // 0x1828, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_InvisWatcherModifier; // 0x1838, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_InfestModifier; // 0x1848, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_InfestWaitingModifier; // 0x1858, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_InfestBarrierModifier; // 0x1868, 0x10 bytes
