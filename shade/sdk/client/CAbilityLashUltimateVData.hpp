...
#include "shade/sdk/client/CBaseLockonAbilityVData.hpp"
...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CAbilityLashUltimateVData : public shade::sdk::client::CBaseLockonAbilityVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadel_Modifier_LashGrappleEnemy_Debuff> m_GrappleEnemyModifier; // 0x1ca0, 0x10 bytes
