    ...
    namespace sdk {
        namespace client {
            ...
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_SnipeModifier; // 0x1b98, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_GlowEnemyModifier; // 0x1ba8, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_KillCheckModifier; // 0x1bb8, 0x10 bytes
