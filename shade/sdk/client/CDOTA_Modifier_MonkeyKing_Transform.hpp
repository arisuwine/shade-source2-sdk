    ...
    namespace sdk {
        namespace client {
            ...
            public:
                ...
                CHandle<shade::sdk::client::C_BaseEntity> m_hCourierToClone; // 0x1a90, 0x4 bytes
                CHandle<shade::sdk::client::C_BaseEntity> m_hCreepToClone; // 0x1a94, 0x4 bytes
                CUtlVector<CHandle<shade::sdk::client::C_BaseEntity>> m_aryBountyRuneSpawners; // 0x1a98, 0x18 bytes
