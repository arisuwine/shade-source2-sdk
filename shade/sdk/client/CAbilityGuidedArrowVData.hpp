    ...
    namespace sdk {
        namespace client {
            ...
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_GuidingModifier; // 0x1cc8, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_DebuffModifier; // 0x1cd8, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_KillCheckModifier; // 0x1ce8, 0x10 bytes
