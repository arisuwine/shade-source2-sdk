...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Ability_InfinitySlashVData : public shade::sdk::client::CCitadelYamatoBaseVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_BuffModifier; // 0x1a88, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_BuffTimerModifier; // 0x1a98, 0x10 bytes
            };
            #pragma pack(pop)
