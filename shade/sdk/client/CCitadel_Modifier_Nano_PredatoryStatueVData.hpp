...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Modifier_Nano_PredatoryStatueVData : public shade::sdk::client::CCitadelModifierVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_TargetModifier; // 0x0a50, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_RevealModifier; // 0x0a60, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_StatueInvis; // 0x0a70, 0x10 bytes
