...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Modifier_StickyBombAttachedVData : public shade::sdk::client::CCitadelModifierVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_OnGroundModifier; // 0x0b00, 0x10 bytes
