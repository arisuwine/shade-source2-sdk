...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Ability_NanoDash_VData : public shade::sdk::client::CitadelAbilityVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_BountyModifier; // 0x1bc8, 0x10 bytes
