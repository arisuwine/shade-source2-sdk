    ...
    namespace sdk {
        namespace client {
            ...
            public:
                ...
                bool m_bActive; // 0x061c, 0x1 bytes
                bool m_bUseScreenAspectRatio; // 0x061d, 0x1 bytes
                std::uint8_t pad_061e[0x2]; // 0x061e, 0x2 bytes
                float m_flAspectRatio; // 0x0620, 0x4 bytes
                bool m_bNoSky; // 0x0624, 0x1 bytes
                std::uint8_t pad_0625[0x3]; // 0x0625, 0x3 bytes
                float m_fBrightness; // 0x0628, 0x4 bytes
                float m_flZFar; // 0x062c, 0x4 bytes
                float m_flZNear; // 0x0630, 0x4 bytes
                bool m_bCanHLTVUse; // 0x0634, 0x1 bytes
                bool m_bAlignWithParent; // 0x0635, 0x1 bytes
                bool m_bDofEnabled; // 0x0636, 0x1 bytes
                std::uint8_t pad_0637[0x1]; // 0x0637, 0x1 bytes
                float m_flDofNearBlurry; // 0x0638, 0x4 bytes
                float m_flDofNearCrisp; // 0x063c, 0x4 bytes
                float m_flDofFarCrisp; // 0x0640, 0x4 bytes
                float m_flDofFarBlurry; // 0x0644, 0x4 bytes
                float m_flDofTiltToGround; // 0x0648, 0x4 bytes
                float m_TargetFOV; // 0x064c, 0x4 bytes
                float m_DegreesPerSecond; // 0x0650, 0x4 bytes
                bool m_bIsOn; // 0x0654, 0x1 bytes
                std::uint8_t pad_0655[0x3]; // 0x0655, 0x3 bytes
                shade::sdk::client::C_PointCamera *m_pNext; // 0x0658, 0x8 bytes
            };
            #pragma pack(pop)
