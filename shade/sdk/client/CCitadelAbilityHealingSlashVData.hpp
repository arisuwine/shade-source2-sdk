    ...
    namespace sdk {
        namespace client {
            ...
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CBaseModifier> m_DebuffModifier; // 0x1838, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CBaseModifier> m_BuffModifier; // 0x1848, 0x10 bytes
