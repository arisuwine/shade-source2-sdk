...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class C_FogController : public shade::sdk::client::C_BaseEntity {
            public:
                shade::sdk::client::fogparams_t m_fog; // 0x05f0, 0x68 bytes
                bool m_bUseAngles; // 0x0658, 0x1 bytes
                std::uint8_t pad_0659[0x3]; // 0x0659, 0x3 bytes
                std::int32_t m_iChangedVariables; // 0x065c, 0x4 bytes
            };
            #pragma pack(pop)
             ...
             * void C_FogControllerSetLerpValues; // Offset: 0x0, Size: 0x1, Size In Bytes: 0x0
             */

            static_assert(sizeof(C_FogController) == 0x660, "C_FogController size mismatch");
        }
    }
}
