...
namespace shade {
    namespace sdk {
        namespace client {
            ...
            public:
                shade::sdk::client::fogparams_t m_fog; // 0x0600, 0x68 bytes
                bool m_bUseAngles; // 0x0668, 0x1 bytes
                std::uint8_t pad_0669[0x3]; // 0x0669, 0x3 bytes
                std::int32_t m_iChangedVariables; // 0x066c, 0x4 bytes
            };
            #pragma pack(pop)
            ...
            static_assert(sizeof(C_FogController) == 0x670, "C_FogController size mismatch");
        }
    }
}
