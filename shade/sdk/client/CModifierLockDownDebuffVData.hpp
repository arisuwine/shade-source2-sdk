...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CModifierLockDownDebuffVData : public shade::sdk::client::CCitadelModifierVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_RootModifier; // 0x0af0, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_BulletResistModifier; // 0x0b00, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_SilencedModifier; // 0x0b10, 0x10 bytes
            };
            #pragma pack(pop)
