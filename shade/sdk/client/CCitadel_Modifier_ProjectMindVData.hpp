...
namespace shade {
    namespace sdk {
        namespace client {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Modifier_ProjectMindVData : public shade::sdk::client::CCitadelModifierVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::client::CCitadelModifier> m_ShieldModifier; // 0x0ad0, 0x10 bytes
            };
            #pragma pack(pop)
