    ...
    namespace sdk {
        namespace server {
            ...
            public:
                ...
                CHandle<shade::sdk::server::CBaseEntity> m_hVisionThinkers[0x8]; // 0x1acc, 0x20 bytes
                CHandle<shade::sdk::server::CBaseEntity> m_hBeamEnd; // 0x1aec, 0x4 bytes
                bool m_bCreatedVisionThinkers; // 0x1af0, 0x1 bytes
                std::uint8_t pad_1af1[0x3]; // 0x1af1, 0x3 bytes
                CHandle<shade::sdk::server::CBaseEntity> m_hBeamEndSound; // 0x1af4, 0x4 bytes
            };
            #pragma pack(pop)
