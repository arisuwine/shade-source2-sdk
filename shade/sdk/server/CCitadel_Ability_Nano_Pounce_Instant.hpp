...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Ability_Nano_Pounce_Instant : public shade::sdk::server::CCitadelBaseAbility {
            public:
            ...
            static_assert(sizeof(CCitadel_Ability_Nano_Pounce_Instant) == 0x14E0, "CCitadel_Ability_Nano_Pounce_Instant size mismatch");
        }
    }
}
