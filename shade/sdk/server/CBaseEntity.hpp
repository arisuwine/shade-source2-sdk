    ...
    namespace sdk {
        namespace server {
            ...
            public:
                ...
                shade::sdk::client::DamageOptions_t m_takedamage; // 0x02e0, 0x1 bytes
                bool m_bTakesDamage; // 0x02e1, 0x1 bytes
                std::uint8_t pad_02e2[0x6]; // 0x02e2, 0x6 bytes
                ...
                std::int32_t m_nPushEnumCount; // 0x03c8, 0x4 bytes
                std::uint8_t pad_03cc[0x4]; // 0x03cc, 0x4 bytes
                shade::sdk::server::CCollisionProperty *m_pCollision; // 0x03d0, 0x8 bytes
                ...
                shade::sdk::client::BloodType m_nBloodType; // 0x0494, 0x4 bytes
            };
            #pragma pack(pop)
            ...
            static_assert(sizeof(CBaseEntity) == 0x498, "CBaseEntity size mismatch");
        }
    }
}
