...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CAbilityWreckerTeleportVData : public shade::sdk::server::CitadelAbilityVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_GuidingModifier; // 0x1ba8, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_DebuffModifier; // 0x1bb8, 0x10 bytes
