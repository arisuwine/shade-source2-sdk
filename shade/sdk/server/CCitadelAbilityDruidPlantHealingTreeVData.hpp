...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CCitadelAbilityDruidPlantHealingTreeVData : public shade::sdk::server::CitadelAbilityVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_HealingAuraModifier; // 0x1b98, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_HealingFruitModifier; // 0x1ba8, 0x10 bytes
            };
            #pragma pack(pop)
