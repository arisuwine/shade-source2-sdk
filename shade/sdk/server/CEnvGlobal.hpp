...
namespace shade {
    namespace sdk {
        namespace server {
            ...
            public:
                CEntityOutputTemplate<std::int32_t> m_outCounter; // 0x04a8, 0x20 bytes
                CUtlSymbolLarge m_globalstate; // 0x04c8, 0x8 bytes
                std::int32_t m_triggermode; // 0x04d0, 0x4 bytes
                std::int32_t m_initialstate; // 0x04d4, 0x4 bytes
                std::int32_t m_counter; // 0x04d8, 0x4 bytes
