...
#include "shade/sdk/server/CCitadel_Ability_BaseHeldItemVData.hpp"
    ...
    namespace sdk {
        namespace server {
            ...
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_DropoffTimerModifier; // 0x1cb0, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_HoldingIdolModifier; // 0x1cc0, 0x10 bytes
