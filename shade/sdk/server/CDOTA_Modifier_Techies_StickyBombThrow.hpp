...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CDOTA_Modifier_Techies_StickyBombThrow : public shade::sdk::client::CDOTA_Buff {
            public:
            ...
            static_assert(sizeof(CDOTA_Modifier_Techies_StickyBombThrow) == 0x1AC0, "CDOTA_Modifier_Techies_StickyBombThrow size mismatch");
        }
    }
}
