...
#include "shade/sdk/server/CCitadel_UtilityUpgrade_RocketBootsVData.hpp"
...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_UtilityUpgrade_RocketBoosterVData : public shade::sdk::server::CCitadel_UtilityUpgrade_RocketBootsVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_DebuffModifier; // 0x1c70, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_BarrierModifier; // 0x1c80, 0x10 bytes
