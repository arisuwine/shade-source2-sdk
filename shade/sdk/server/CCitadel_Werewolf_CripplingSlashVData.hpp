...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Werewolf_CripplingSlashVData : public shade::sdk::server::CitadelAbilityVData {
            public:
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_DebuffModifier; // 0x1818, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_DisarmModifier; // 0x1828, 0x10 bytes
