...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Ability_Frank_ReviveVData : public shade::sdk::server::CitadelAbilityVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_RevivingModifier; // 0x1d78, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_SlowModifier; // 0x1d88, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_DashSlowModifier; // 0x1d98, 0x10 bytes
            };
            #pragma pack(pop)
