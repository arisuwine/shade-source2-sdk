    ...
    namespace sdk {
        namespace server {
            ...
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_DebuffModifier; // 0x1af8, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_TargetLifestealModifier; // 0x1b08, 0x10 bytes
