...
namespace shade {
    namespace sdk {
        namespace server {
            ...
            public:
                CHandle<shade::sdk::server::CPathTrack> m_pnext; // 0x04a8, 0x4 bytes
                CHandle<shade::sdk::server::CPathTrack> m_pprevious; // 0x04ac, 0x4 bytes
                CHandle<shade::sdk::server::CPathTrack> m_paltpath; // 0x04b0, 0x4 bytes
                float m_flSpeed; // 0x04b4, 0x4 bytes
