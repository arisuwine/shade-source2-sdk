...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_WeaponUpgrade_ExpressShot_VData : public shade::sdk::server::CitadelItemVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_ProcNotificationModifier; // 0x1a90, 0x10 bytes
            };
            #pragma pack(pop)
