    ...
    namespace sdk {
        namespace server {
            ...
            public:
                ...
                std::int32_t m_nOpvarType; // 0x04c8, 0x4 bytes
                std::int32_t m_nOpvarIndex; // 0x04cc, 0x4 bytes
                float m_flOpvarValue; // 0x04d0, 0x4 bytes
                std::uint8_t pad_04d4[0x4]; // 0x04d4, 0x4 bytes
                CUtlSymbolLarge m_OpvarValueString; // 0x04d8, 0x8 bytes
                bool m_bSetOnSpawn; // 0x04e0, 0x1 bytes
                std::uint8_t pad_04e1[0xf]; // 0x04e1, 0xf bytes
            };
            #pragma pack(pop)
            ...
            static_assert(sizeof(CSoundOpvarSetEntity) == 0x4F0, "CSoundOpvarSetEntity size mismatch");
        }
    }
}
