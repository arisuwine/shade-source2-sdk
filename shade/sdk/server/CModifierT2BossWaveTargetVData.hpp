    ...
    namespace sdk {
        namespace server {
            ...
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_DisarmModifier; // 0x0770, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_SlowModifier; // 0x0780, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_BulletResistModifier; // 0x0790, 0x10 bytes
