...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Ability_Tier3Boss_DropBombsVData : public shade::sdk::server::CitadelAbilityVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_CurseModifier; // 0x1dc8, 0x10 bytes
