...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CCitadel_Ability_Necro_ZombieWallVData : public shade::sdk::server::CitadelAbilityVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_GroundAuraModifier; // 0x19e8, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_TetherModifier; // 0x19f8, 0x10 bytes
