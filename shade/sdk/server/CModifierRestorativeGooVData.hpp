...
namespace shade {
    namespace sdk {
        namespace server {
             ...
             */
            #pragma pack(push, 1)
            class CModifierRestorativeGooVData : public shade::sdk::server::CCitadelModifierVData {
            public:
                ...
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_BreakoutProgressBarModifier; // 0x09f0, 0x10 bytes
                CEmbeddedSubclass<shade::sdk::server::CCitadelModifier> m_PostCubeBuffModifier; // 0x0a00, 0x10 bytes
