    ...
    namespace sdk {
        namespace server {
            ...
            public:
                ...
                CUtlVector<CHandle<shade::sdk::server::CBaseEntity>> m_vecHeroesHitLastRicochet; // 0x1ab0, 0x18 bytes
                CUtlVector<CHandle<shade::sdk::server::CBaseEntity>> m_vecHeroesCredited; // 0x1ac8, 0x18 bytes
                CUtlVector<CHandle<shade::sdk::server::CBaseEntity>> m_vecHeroesHitCurrentRicochet; // 0x1ae0, 0x18 bytes
            };
            #pragma pack(pop)
