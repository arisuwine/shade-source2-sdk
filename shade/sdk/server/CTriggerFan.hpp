...
namespace shade {
    namespace sdk {
        namespace server {
            ...
            public:
                Vector m_vFanOriginOffset; // 0x08f0, 0xc bytes
                Vector m_vDirection; // 0x08fc, 0xc bytes
                bool m_bPushTowardsInfoTarget; // 0x0908, 0x1 bytes
                bool m_bPushAwayFromInfoTarget; // 0x0909, 0x1 bytes
