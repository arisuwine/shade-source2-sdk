    ...
    namespace sdk {
        namespace server {
            ...
            public:
                ...
                bool m_bUseScreenAspectRatio; // 0x04b5, 0x1 bytes
                std::uint8_t pad_04b6[0x2]; // 0x04b6, 0x2 bytes
                float m_flAspectRatio; // 0x04b8, 0x4 bytes
                bool m_bNoSky; // 0x04bc, 0x1 bytes
                std::uint8_t pad_04bd[0x3]; // 0x04bd, 0x3 bytes
                float m_fBrightness; // 0x04c0, 0x4 bytes
                float m_flZFar; // 0x04c4, 0x4 bytes
                float m_flZNear; // 0x04c8, 0x4 bytes
                bool m_bCanHLTVUse; // 0x04cc, 0x1 bytes
                bool m_bAlignWithParent; // 0x04cd, 0x1 bytes
                std::uint8_t pad_04ce[0x2]; // 0x04ce, 0x2 bytes
                float m_flOverrideShadowFarZ; // 0x04d0, 0x4 bytes
                bool m_bDofEnabled; // 0x04d4, 0x1 bytes
