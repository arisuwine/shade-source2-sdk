...
namespace shade {
    namespace sdk {
        namespace server {
            ...
            public:
                shade::sdk::server::fogparams_t m_fog; // 0x0498, 0x68 bytes
                bool m_bUseAngles; // 0x0500, 0x1 bytes
                std::uint8_t pad_0501[0x3]; // 0x0501, 0x3 bytes
                std::int32_t m_iChangedVariables; // 0x0504, 0x4 bytes
            };
            #pragma pack(pop)
            ...
            static_assert(sizeof(CFogController) == 0x508, "CFogController size mismatch");
        }
    }
}
