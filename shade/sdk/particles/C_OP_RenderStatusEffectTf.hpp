...
namespace shade {
    namespace sdk {
        namespace particles {
             ...
             */
            #pragma pack(push, 1)
            class C_OP_RenderStatusEffectTf : public shade::sdk::particles::CParticleFunctionRenderer {
            public:
            ...
            static_assert(sizeof(C_OP_RenderStatusEffectTf) == 0x268, "C_OP_RenderStatusEffectTf size mismatch");
        }
    }
}
