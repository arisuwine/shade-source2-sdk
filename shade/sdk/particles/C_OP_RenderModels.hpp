    ...
    namespace sdk {
        namespace particles {
            ...
            public:
                ...
                char m_ClothEffectName[0x40]; // 0x1a19, 0x40 bytes
                std::uint8_t pad_1a59[0x7]; // 0x1a59, 0x7 bytes
                ...
                shade::sdk::particles::ParticleColorBlendType_t m_nColorBlendType; // 0x2c60, 0x4 bytes
                std::uint8_t pad_2c64[0x44]; // 0x2c64, 0x44 bytes
            };
            #pragma pack(pop)

            // No unique data map fields

            static_assert(sizeof(C_OP_RenderModels) == 0x2CA8, "C_OP_RenderModels size mismatch");
        }
    }
}
