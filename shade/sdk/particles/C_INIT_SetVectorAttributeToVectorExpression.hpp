    ...
    namespace sdk {
        namespace particles {
            ...
            public:
                ...
                bool m_bNormalizedOutput; // 0x1120, 0x1 bytes
                std::uint8_t pad_1121[0x6f]; // 0x1121, 0x6f bytes
            };
            #pragma pack(pop)

            // No unique data map fields

            static_assert(sizeof(C_INIT_SetVectorAttributeToVectorExpression) == 0x1190, "C_INIT_SetVectorAttributeToVectorExpression size mismatch");
        }
    }
}
